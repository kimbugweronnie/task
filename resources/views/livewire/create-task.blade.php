        ...
        <div class="col-lg-12">
            ...
            <div class="border rounded-3 bg-white shadow py-4 px-5">
                <form  wire:submit="storeTask">
                    <div class="row mb-2">
                        <div class="col-4">
                            <label for="project" class="form-label text-capitalize">Project</label>
                        ...
                        <div class="col-4"> 
                            <label for="priority" class="form-label text-capitalize">Priority</label>
                            <input type="number" min="1" wire:model="priority"  class="form-control @error('priority') is-invalid @enderror"  id="priority">
                            @error('priority')
                                <span class="invalid-feedback" role="alert">
                                    <strong>The priority is required.</strong>
                                </span>
                            @enderror
                        </div>
                    </div>
